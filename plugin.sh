...
MIGRATION_TAG=${PLUGIN_MIGRATION_TAG:-${DRONE_TAG:-${DRONE_SEMVER:-${DRONE_COMMIT_SHA:0:6}}}}
DRONE_TAG=${MIGRATION_TAG}
echo ">>> Using MIGRATION_TAG: ${MIGRATION_TAG} & IMAGE_VERSION: ${IMAGE_VERSION} & DRONE_TAG: ${DRONE_TAG}<<<"
